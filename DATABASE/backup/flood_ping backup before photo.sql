...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2024 at 04:33 AM
...
INSERT INTO `residents` (`id`, `first_name`, `middle_name`, `last_name`, `suffix`, `sex`, `date_of_birth`, `mobile_number`, `email_address`, `civil_status`, `socioeconomic_category`, `health_status`, `house_lot_number`, `street_subdivision_name`, `barangay`, `municipality`, `account_status`) VALUES
(1, 'Sana', 'Batumbakal', 'Minatozaki', 'II', 'female', '2004-02-09', '09123456789', 'sana.bading@gmail.com', 'married', 'single parent', 'in good health', '51', 'Manggahan Street', 'Bagbag', 'Quezon City', 'active');
