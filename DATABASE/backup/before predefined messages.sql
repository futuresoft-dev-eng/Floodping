...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2024 at 07:46 AM
...
CREATE TABLE `flood_alerts` (
  ...
  `status` enum('New','False Alert','SMS Sent') NOT NULL DEFAULT 'New',
...
INSERT INTO `flood_alerts` (`flood_id`, `date`, `time`, `height`, `speed`, `flow`, `water_level`, `status`, `message_content`) VALUES
(1, '2024-10-20', '11:00:00', 13.00, 0.04, 'Rising', 'Moderate', 'New', 'FLOODPING (11:00AM, 20Oct24)\nDarius Creek: Moderate Water Level (13m)\nPatuloy ang pagtaas ng baha. Nagaganap ang sapilitang pagpapalitas para sa kaligtasan ng lahat. Ang evacuation sites ay sa Bagbag at Goodwill Elem School. Ang lahat ay pinag-iingat.'),
(2, '2024-10-21', '14:30:00', 10.00, 0.02, 'Lowering', 'Low', 'New', 'FLOODPING (2:30PM, 21Oct24)\nDarius Creek: Low Water Level (10m)\nBumaba na ang tubig, ngunit patuloy na mag-ingat.');
...
INSERT INTO `sms_alerts` (`sms_alert_id`, `flood_id`, `date_sent`, `time_sent`, `recipients`, `sending_progress`, `status`) VALUES
(1, 1, '2024-10-20', '11:01:00', 10, 'Pending', 'Pending'),
(2, 2, '2024-10-21', '14:35:00', 5, 'Pending', 'Pending');
...
--
-- Dumping data for table `sms_logs_pending`
--

INSERT INTO `sms_logs_pending` (`sending_id`, `date_sent`, `recipients`, `flood_id`, `water_level`, `sending_progress`) VALUES
(2, '2024-10-21', 5, 2, 'Low', 'In Progress');
...
(1, '2024-10-20', '11:05:00', 10, 0, 10, 1, 'Moderate', 10, 'LA One'),
(2, '2024-10-21', '14:40:00', 5, 0, 5, 2, 'Low', 5, 'LA Two'),
(3, '2024-10-20', '11:38:10', 10, 0, 10, 1, 'Moderate', 10, 'LA Three');
...
--
ALTER TABLE `flood_alerts`
  MODIFY `flood_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `sms_alerts`
  MODIFY `sms_alert_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `sms_logs_pending`
--
ALTER TABLE `sms_logs_pending`
  MODIFY `sending_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `sms_logs_sent`
--
ALTER TABLE `sms_logs_sent`
  MODIFY `sms_batch_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
